...
下载：[PidocDesktop Win64 V0.1.1](https://dl.pidoc.cn/pidoc/pidocdesktop-0.1.1-windows-amd64.zip)
...
| websocket_url | string | WebSocket 地址穿越服务URL。当前仅有 `wss://ops.pidoc.cn/api/endpoint/ws-tunnel` 可用，可不填写。未来会提供更多服务器地址以分担压力。 | 2.0.7 |
