...
- `int64_t divmod_s64s64 (int64_t a, int64_t b)` <span className="chip-tag rp2040">RP2040</span>: 两个有符号 64 位值的整数除法。
...
- `uint64_t divmod_u64u64 (uint64_t a, uint64_t b)` <span className="chip-tag rp2040">RP2040</span>: 两个无符号 64 位值的整数除法。
...
- divmod_result_t divmod_s32s32_unsafe (int32_t a, int32_t b): 两个有符号 32 位值的不安全整数除法。
...
- `uint64_t divmod_u64u64_unsafe (uint64_t a, uint64_t b)`: 两个无符号 64 位值的不安全整数除法。
...
`int64_t divmod_s64s64 (int64_t a, int64_t b)` <span className="chip-tag rp2040">RP2040</span>
...
`uint64_t divmod_u64u64 (uint64_t a, uint64_t b)` <span className="chip-tag rp2040">RP2040</span>
