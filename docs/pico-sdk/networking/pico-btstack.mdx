...
更多详情请参阅 [How to configure BTstack](https://bluekitchen-gmbh.com/btstack/develop/#how_to/) 及相关 [pico-examples](https://github.com/raspberrypi/pico-examples#pico-bluetooth)。
