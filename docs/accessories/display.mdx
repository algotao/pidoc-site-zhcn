...
sidebar_position: 15
draft: false
description: 树莓派7英寸触摸显示屏是一款兼容多型号树莓派的液晶显示设备，通过DSI和GPIO连接器与树莓派相连。该显示屏具备800×480px分辨率、24位色彩、10点多点触控功能，支持140度水平视角和120度垂直视角，适用于工业环境。显示屏采用金属框架设计，背光寿命长达20000小时，工作温度范围为-20至+70摄氏度。用户可通过树莓派GPIO或微型USB供电，并支持屏幕键盘、屏幕方向及触摸输入的自定义配置。适用于需要触控交互的树莓派项目。
keywords: [树莓派触摸显示屏, 7英寸, 液晶显示, DSI连接, GPIO连接, 10点触控, 工业品质, 金属框架, 背光寿命, 屏幕键盘, 屏幕方向, 触摸输入配置, 树莓派兼容性, Raspberry Pi, 触控交互]
last_update: 
  date: 2026-03-15
---
...
:::note[注意]
您可以下载触摸显示屏的[机械图纸](https://pip.raspberrypi.com/documents/RP-008246-DS)。
:::
