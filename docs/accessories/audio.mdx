...
sidebar_position: 15
draft: false
description: 树莓派音频板可为您现有的高保真音响或基于树莓派的设备和项目带来高品质音频，本文介绍了4种音频板：DAC Pro、DAC+、DigiAMP、Codec Zero。
keywords: [树莓派, Raspberry Pi, 音频, 声卡, 声音, audio, DAC, DigiAMP, ]
last_update: 
  date: 2024-12-20
---
...
<img src="/img/accessories/audio/pin_table_new.jpg" width="80%" alt="新引脚表" />
