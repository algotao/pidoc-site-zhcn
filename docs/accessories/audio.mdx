...
DigiAMP+ 使用德州仪器公司的 TAS5756M PowerDAC。

必须由外部电源供电。它需要 12-24V 直流电源（推荐使用 XP Power VEC65US19 电源）。

:::note
DigiAMP+ 专为 Raspberry Pi 3 及更早型号的设备设计。若将其与 Raspberry Pi 4 或更新型号的设备配合使用，请使用外接电源供电的 USB 集线器，以防止 USB 端口给设备增加额外负载。若未采取此措施，可能会导致出现低电量警告。
:::

<img src="/img/accessories/audio/DigiAMP+_Board_Diagram.jpg" width="80%" alt="DigiAmp+ 电路板的俯视图，显示了丝印标识和元器件。" />
...
从电路板顶部向下看，且电源连接器位于左侧时，两个端子的极性相同：左侧为"−"，右侧为"+"。
...
### 设置树莓派
在本例中，我们使用的是树莓派OS Lite。更多详情，请参阅我们的 [树莓派OS安装](../computers/getting-started.mdx#将操作系统安装到启动介质上)指南。
...
<img src="/img/accessories/audio/pin_out_new.png" width="80%" alt="新引脚" />
