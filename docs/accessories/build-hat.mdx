...
sidebar_position: 11
draft: false
description: 树莓派Build HAT是一款专为乐高®教育设计的附加板，通过40引脚GPIO接口与树莓派连接，支持控制SPIKE™系列乐高® Technic™电机和传感器（如距离、颜色、力传感器及多尺寸编码电机）。它兼容所有40引脚GPIO树莓派（包括Zero系列和键盘系列设备），需外接8V电源驱动电机，并提供Python和.NET两种编程库。Build HAT板载RP2040微控制器管理底层控制，支持即插即用，简化乐高®机械结构的编程与交互，适用于STEM教育、机器人开发等场景。
keywords: [树莓派Build HAT, 乐高® Technic™, 乐高® SPIKE™, 电机控制, 传感器, Python库, .NET框架, RP2040微控制器, 40引脚GPIO, 乐高®教育, STEM教育, 机器人开发]
last_update: 
  date: 2026-05-03
---
...
:::warning
Raspberry Pi Build HAT目前尚未获得树莓派操作系统*Trixie*的支持。若需使用Build HAT，请暂时安装或继续使用树莓派操作系统*Bookworm*。
:::
...
- 板载 [RP2040](../microcontrollers/microcontroller-chips) 微控制器管理 乐高® Technic™ 设备的底层控制
...
:::note[注意]
在开始使用树莓派Build HAT 之前，您应该[设置](../computers/getting-started.mdx#desktop-setup)好树莓派，并使用 [树莓派Imager](/downloads/) [安装](../computers/getting-started.mdx#使用-imager-安装)最新版本的操作系统。
:::
...
<img src="/img/accessories/build-hat/tall-headers.jpg" width="80%" alt="高针座" />
...
树莓派启动后，请通过选择树莓派菜单按钮，然后选择**首选项 > 控制中心**来打开控制中心工具。

选择**接口**选项卡，并按照下图所示调整串行设置：

<img src="/img/accessories/build-hat/setting-up.png" width="50%" alt="接口选项卡。SSH、VNC和串行端口已启用。其余选项均未启用。" />
...
### .NET使用Build HAT
树莓派Build HAT 在乐高®术语中称为 "Brick"(砖块)，您可以使用 [Build HAT 串行协议](https://pip.raspberrypi.com/documents/RP-008140-DS)直接从 .NET 与它对话。
...
您可以下载以下文档、
- [树莓派 Build HAT 串行协议](https://pip.raspberrypi.com/documents/RP-008140-DS)
- [树莓派 Build HAT Python 库](https://pip.raspberrypi.com/documents/RP-008139-DS)
