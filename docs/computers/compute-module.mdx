...
* 用于 CM0 的 BCM2837(2025年09月由上海晶珩发布)
* 用于 CM1 的 BCM2835
...
计算模块 0（CM0）包含 Raspberry Pi RP3A0 处理器（BCM2710A1 和 512MB 内存）以及可选的 0GB/8GB/16GB eMMC 闪存。CM0 采用 39x33mm 超小型邮票孔核心板 外形。
