...
若需恢复至树莓派操作系统精简版，可卸载这些软件包。若希望保留已安装的桌面软件包同时体验精简版功能，请使用 [raspi-config](./configuration.mdx#raspi-config) 工具将树莓派设置为启动时进入命令行界面。
...
<img src="/img/computers/os/thonny-venv.png" alt="thonny-venv" />
