...
draft: false
title_meta:  树莓派5是官方最新版的硬件，包含四核2.4GHz的64位Arm Cortex-A76
...
:::tip[重要]
如果您是第一次使用树莓派，请参阅我们有关[如何开始的说明](./getting-started.mdx#配置向导)。
:::
...
有关在树莓派上使用GPIO引脚的更多信息可以在[文档的其他地方](./raspberry-pi.mdx#gpio)找到。
