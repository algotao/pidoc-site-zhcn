...
- [机械图纸，PDF](https://pip.raspberrypi.com/documents/RP-008352-DS)
- [机械制图，DXF](https://pip.raspberrypi.com/documents/RP-008351-DS)
...
2. 选择一张未使用的SD卡。刻录工具将覆盖该SD卡上的所有数据。
3. 将SD卡插入运行 Imager 的计算机。
4. 启动树莓派 Imager。
5. 在**设备**选项卡中，从列表中选择您的树莓派型号。点击**下一步**。
6. 在**操作系统**选项卡中，选择**其他实用工具映像**

<img src="/img/computers/raspberry-pi/misc-utility-images.png" width="60%" alt="其他工具映像" />

7. 根据您的树莓派版本选择**Bootloader**。

<img src="/img/computers/raspberry-pi/bootloader-family-select.png" width="60%" alt="为您的bootloader选择一个系列" />

8. 选择启动模式。我们推荐 **SD卡启动**。点击 **下一步**。

<img src="/img/computers/raspberry-pi/bootloader-storage-select.png" width="60%" alt="选择您要从中启动的存储" />

9. 在 **存储** 选项卡中选择您的SD卡。点击 **下一步**。.
10. 在 **写入** 选项卡中确认设置，点击 **写入** 继续。
11. 系统将提示确认是否覆盖SD卡数据。继续操作请选择 **我已知晓，擦除并写入**。
12. 等待 Imager 完成SD卡写入与验证.
13. 将SD卡插入需更新 bootloader 的树莓派设备.
14. 使用新镜像启动树莓派并等待至少十秒.
15. 当绿色活动指示灯以稳定模式闪烁且HDMI显示屏呈现绿色背景时，即表示引导程序写入成功.
16. 关闭树莓派电源并取出SD卡
