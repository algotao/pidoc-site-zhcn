...
:::important[重要]
由于核心SoC停产，树莓派2B的1.1版和1.2版已达到产品生命周期终止（EoL）。官方EoL日期为2025年10月16日。树莓派2B修订版1.3采用相同机械尺寸并搭载BCM2837B0处理器，因此推荐用于现有设计。更多详情请参阅官方[停产通知](https://pip.raspberrypi.com/documents/RP-009284-PC-2)。
:::
...
<table>
    ...
    <tr>
        ...
        <td>[RP2350](../microcontrollers/silicon.mdx#rp2350)</td>
        <td>520KB</td>
        <td>4MB</td>
        <td>2个20针GPIO头(未填充)</td>
        <td>无</td>
...
[在树莓派上使用 DPI 显示器](https://pip.raspberrypi.com/documents/RP-003471-WP-Using-a-DPI-display.pdf)<br />
...
:::info[白皮书]
[打造弹性更强的文件系统](https://pip.raspberrypi.com/documents/RP-003610-WP-Making-a-more-resilient-file-system.pdf)
