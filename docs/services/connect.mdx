...
* 向 `api.connect.raspberrypi.com` 的 443 端口上的 Raspberry Pi Connect API 提出未经验证的 HTTPS 请求 
* 通过`api.connect.raspberrypi.com`的 443 端口对 Raspberry Pi Connect API 的验证请求
