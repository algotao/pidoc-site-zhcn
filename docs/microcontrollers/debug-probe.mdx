...
调试探头固件的最新版本是 2.3.0。如果您运行的是旧版本，或者不小心覆盖了调试探针上的固件，您可以在 [the debugprobe GitHub repository](https://github.com/raspberrypi/debugprobe/releases/latest) 中找到最新版本的固件。
...
对于固件版本 2.3.0 的调试探针，将显示 `bcdDevice 2.23`。
