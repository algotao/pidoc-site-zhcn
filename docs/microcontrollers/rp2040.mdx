...
无论您拥有的是[树莓派 Pico](./pico-series.mdx#raspberry-pi-pico)还是其他基于 RP2040 的微控制器板，这里都有您入门所需的一切。您可以找到在树莓派 Pico 上开始使用 [C/C++](./c-sdk.mdx#sdk安装) 或 [MicroPython](./micropython.mdx#什么是micropython) 的支持，以及使用 RP2040 的其他电路板的资源链接。这里还有 树莓派 Pico 微控制器板和 RP2040 微控制器芯片技术文档的链接。
...
:::info[白皮书]
[用于低待机电流应用的功率开关 RP2040](https://pip.raspberrypi.com/documents/RP-004339-WP-Power-switching-RP2040-for-low-standby-current-applications.pdf)
