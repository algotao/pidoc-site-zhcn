...
我们的官方 C SDK 可在命令行中使用，也可在 Visual Studio Code 和 CLion 等流行的集成开发环境中使用。要开始使用，请下载我们的 C/C++ SDK 和示例，并查看我们的 [Raspberry Pi Pico 系列入门](https://datasheets.raspberrypi.com/pico/getting-started-with-pico.pdf) 文档。如需快速设置，请参阅下一节。
...
[Pico W 系列设备的 Wi-Fi 和蓝牙连接](https://pip.raspberrypi.com/documents/RP-008257-DS)<br />
&emsp;&emsp;在 Pico W 系列设备上使用 C/C++ 或 MicroPython 进行无线连接
