...
sidebar_position: 5
draft: false
description: 树莓派Pico C/C++ SDK。我们的官方 C SDK 可在命令行中使用，也可在常用的集成开发环境（如 Visual Studio Code、Eclipse 和 CLion）中使用。要开始使用，请下载我们的 C/C++ SDK 和示例，并查看我们的"入门"文档。如需快速安装，请参阅下一节。
keywords: [树莓派, Raspberry Pi, C/C++ SDK, Pico]
last_update: 
  date: 2024-12-21
---
