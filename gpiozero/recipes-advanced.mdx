...
draft: false
title: 3. 高阶用法
description: 本文聚焦GPIO Zero库的高阶用法，以Python 3编写示例。涵盖LEDBoard对象操作，如逐个遍历、索引访问、切片选取及命名访问，还支持嵌套。介绍多字符7段显示屏电路原理与信息滚动代码。此外，包括谁在家指示灯、Travis构建LED指示灯等应用，以及按钮控制机器人、电位器控制机器人等进阶操作，还有BlueDot蓝牙控制相关示例和Pi自身LED灯控制等内容。
keywords: [GPIO Zero, 高阶用法, LEDBoard, 多字符7段显示屏, 谁在家指示灯, Travis构建LED指示灯, 按钮控制机器人, 电位器控制机器人, BlueDot, Pi自身LED灯控制]
last_update: 
  date: 2024-06-13
---
