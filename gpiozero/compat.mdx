...
draft: false
title: 10. 向后兼容性
description: 本文介绍GPIO Zero 2.x版本的向后兼容性情况。该版本有诸多重大变化，如不再支持Python 2.x，删除RPIO引脚工厂、已废弃的引脚工厂别名。许多类构造函数和方法的关键字参数需规范使用，机器人应用接口有调整，PiBoardInfo等相关类也进行了重大重组，同时记录了从1.x到2.x的重大变化及未来2.x版本中计划删除的过时功能。
keywords: [GPIO Zero, 向后兼容性, GPIO Zero 2.x, Python 2.x, 引脚工厂, 关键字参数, 机器人接口, PiBoardInfo, 过时功能]
last_update: 
  date: 2024-06-14
---
